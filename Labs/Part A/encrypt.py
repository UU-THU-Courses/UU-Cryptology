...
def main_function(char_list, char_dict):
    ...
    # Save results
    with open("./outputs/vig_group13.plain", "w", encoding="UTF-8") as f:
        f.write(clean_text)
    with open("./outputs/vig_group13.key", "w", encoding="UTF-8") as f:
        f.write(enc_key)
    with open("./outputs/vig_group13.crypto", "w", encoding="UTF-8") as f:
        f.write(cipher_text)
